...
namespace SailorsWebApi.Controllers
{
    public class DocumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "documentId,documentName,documentType")] Documents documents)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "documentId,documentName,documentType")] Documents documents)
        {
            if (ModelState.IsValid)
            {
